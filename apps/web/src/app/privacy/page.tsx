...
const sections = [
  ...
  {
    title: "4. 방문 분석",
    body: "서비스 개선을 위해 Vercel Web Analytics로 방문 시각, 페이지 경로, 유입 경로, 국가·지역 수준의 위치, 기기·운영체제·브라우저 종류 같은 집계 정보를 처리합니다. 댓글·제보 본문이나 이메일 주소를 분석 이벤트에 넣지 않으며, 개인을 식별하는 사용자 계정 기반 추적은 사용하지 않습니다.",
  },
  {
    title: "5. 문의와 권리 행사",
