...
> = {
  ...
  trending: {
    label: "바이럴 영상 제안",
    buttonLabel: "바이럴 영상 추가",
    eyebrow: "VIRAL VIDEO PROPOSAL",
    prompt: "바이럴 TOP 10을 어떻게 바꿀까요?",
    placeholder: "추가하거나 수정할 영상과 실제 확산에 기여한 이유, 확인 가능한 지표를 적어주세요.",
    actions: [
      { value: "확산 영상 추가", label: "바이럴 영상 추가" },
  ...
  related: {
    label: "챌린지 영상 추가",
    buttonLabel: "챌린지 추가하기",
    eyebrow: "ADD YOUR CHALLENGE",
    prompt: "어떤 참여 영상을 추가할까요?",
    placeholder: "챌린지 참여 영상, 패러디나 변형 영상의 설명을 간단히 적어주세요.",
    actions: [
      { value: "관련 영상 추가", label: "내 챌린지 영상 추가" },
      { value: "영상 정보 수정", label: "영상 정보 수정" },
      { value: "영상 제외 제안", label: "관련성이 낮은 영상 제외" },
    ],
  },
