...
export function QuizDetailModal({ card, onClose, onOpenPage }: QuizDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/55 sm:items-center sm:p-4">
      ...
      <section aria-labelledby="quiz-media-title" aria-modal="true" className="relative flex h-[92dvh] w-full max-w-3xl flex-col overflow-hidden rounded-t-2xl bg-white shadow-2xl sm:h-[86vh] sm:rounded-2xl" role="dialog">
